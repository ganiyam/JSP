...
<%
    try(DBConnector con = new DBConnector();) {
		...
		request.getParameter("searchnum").equalsIgnoreCase("all"))
		exec= map.getBoardAll();
		else if(request.getParameter("searchnum").equalsIgnoreCase("id"))
		exec = map.getBoardByNum(request.getParameter("id"));    */
